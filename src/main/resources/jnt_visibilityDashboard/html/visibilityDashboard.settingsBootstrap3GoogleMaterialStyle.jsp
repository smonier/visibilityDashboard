...
<template:addResources>
    <script type="text/javascript">
        $(document).ready(function () {
            dataTablesSettings.init('visibilityContentTable', 25, [], true, null);
         });
    </script>
</template:addResources>
      ...
      <thead>
        <tr>
          ...
          <th width="20%"><fmt:message
                                       key="visibilityDashboard.table.view" /></th>
          ...
          <tr>
            ...
            <td width="20%">  
              <button type="button"
                      ...
                      data-target="#${visibilityContent.parent.UUID}" style="float:middle">
